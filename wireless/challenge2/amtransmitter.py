...
class amtransmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "amtransmitter")
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 10, 0.1, 1.2, 200)
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:50001', 100, False, -1, '')
        ...
        self.connect((self.blocks_float_to_complex_1, 0), (self.blocks_repeat_0, 0))
...
def main(top_block_cls=amtransmitter, options=None):
